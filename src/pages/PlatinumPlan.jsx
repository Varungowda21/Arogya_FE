...
import img2 from '../assets/bakery_image.png'
import img3 from '../assets/fresh_fruits_image.png'
import { FaWhatsapp } from 'react-icons/fa'
import { FaPhoneAlt } from 'react-icons/fa' // Import this at the top

const images = [img1, img2, img3]

export default function PlatinumPlan() {
     useEffect(() => {
        window.scrollTo({ top: 0, behavior: 'smooth' });
      }, []);
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 mt-24">
      <h1 className="text-3xl font-bold mb-6 text-center">Platinum Plan</h1>
      ...
      <p className="text-lg text-gray-700 mb-4">
        Unlock premium features and dedicated support with our Platinum Plan. Ideal for professionals seeking top-tier service.
      </p>
