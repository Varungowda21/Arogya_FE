...
export default function SilverPlan() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10 mt-24">
      <h1 className="text-3xl font-bold mb-6 text-center">Sliver Plan</h1>
      ...
      <p className="text-lg text-gray-700 mb-4">
        Unlock premium features and dedicated support with our Silver Plan. Ideal for professionals seeking top-tier service.
      </p>
