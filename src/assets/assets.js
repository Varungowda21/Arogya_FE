...
import main_banner_bg_sm from "./Am_banner_bg.jpg";
...
export const categories = [

  {
    ...
    bgColor: "#FFE4E1", // Light peach-pink (fresh fruity feel)
  },
  {
    text: "Healthy Drinks",
    path: "Drinks",
    image: bottles_image,
    bgColor: "#D1F2EB", // Aqua-mint (fresh drink vibe)
  },
  {
    text: "Dairy Products",
    path: "Dairy",
    image: dairy_product_image,
    bgColor: "#FFF9E5", // Light cream (milk/dairy feel)
  },
  {
    text: "Fresh Vegetables",
    path: "Vegetables",
    image: organic_vegitable_image,
    bgColor: "#E6F4EA", // Soft green (fresh vegetable feel)
  },
  {
    text: "Essential Products",
    path: "Bakery",
    image: bakery_image,
    bgColor: "#FFF1E6", // Soft warm beige (fresh bakery feel)
  },
  {
    text: "Festival Items",
    path: "Grains",
...
export const features = [
  {
    ...
    description: "fresh meals delivered in under 30 minutes.",
  },
  {
    icon: leaf_icon,
  ...
  },
  {
    ...
    description: "Quality meals at unbeatable prices.",
  },
