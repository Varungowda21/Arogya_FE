...
<nav className="z-50 fixed top-0 left-0 right-0 flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white transition-all">
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        <div className="hidden sm:flex items-center gap-4 ml-6">
          ...
          <a href="https://wa.me/919113998915" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-500 text-xl transition-transform hover:scale-110">
            <FaWhatsapp />
          </a>
      ...
      {open && (
        <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex flex-col items-start gap-2 px-5 text-sm md:hidden">
          ...
          <div className="flex items-center gap-4 mt-4">
            <a href="https://www.instagram.com/arogya_mandya?igsh=MWxha240ZWJhcjloYQ==" target="_blank" rel="noopener noreferrer" className="text-pink-500 text-xl transition-transform hover:scale-110">
              <FaInstagram />
            </a>
            <a href="https://wa.me/+919113998915" target="_blank" rel="noopener noreferrer" className="text-green-500 text-xl transition-transform hover:scale-110">
              <FaWhatsapp />
            </a>
            <a href="https://www.facebook.com/profile.php?id=61575630644614" target="_blank" rel="noopener noreferrer" className="text-blue-600 text-xl transition-transform hover:scale-110">
              <FaFacebookF />
            </a>
          </div>
